...
export const SparklesIcon = ({ size = 20 }: { size?: number }) => (
  ...
  >
    ...
    {/* Main circle background - dark in light theme, light in dark theme */}
    <circle
      cx="52.06"
      cy="52.06"
      r="52.01"
    ...
    <g className="odai-rotating fill-white dark:fill-black">
      ...
      <path d="M91.44,30.41l1.57,3.15-14.07,7.02-1.57-3.15,14.07-7.02h0Z" />
      <path d="M88.81,26.21l-12.54,9.49-1.91-2.52,12.54-9.49,1.91,2.52h0Z" />
      <path d="M83.32,19.78l-10.6,11.62-2.07-1.89,10.6-11.62,2.07,1.89h0Z" />
      <path d="M76.72,14.5l-8.29,13.35-2.08-1.28,8.29-13.35,2.08,1.28h0Z" />
      <path d="M67.31,9.78l1.94.75-5.69,14.66-1.94-.75,5.69-14.66h0Z" />
      <path d="M59.45,7.74l1.69.31-2.87,15.46-1.69-.31,2.87-15.46h0Z" />
      <path d="M51.38,7.13h1.36v15.73h-1.36v-15.73h0Z" />
      
      {/* Bottom-right thick segments */}
      <path d="M91.03,74.38l-13.56-6.77,12.11,9.15-3.43,4.53-10.56-7.99,8.94,9.79-4.46,4.07-7.6-8.33,5.96,9.6-5.44,3.37-4.92-7.93,3.38,8.71-6.31,2.45-2.68-6.92,1.36,7.31-7,1.3-1-5.37v5.48h-7.48v-15.72h6.46l5.3-.99,5.02-1.95,4.59-2.84,3.99-3.64,3.28-4.34h0l2.37-4.76,14.07,7.02-2.37,4.76h-.02Z" />
      <path d="M94.54,66.66l-15.12-4.3,1.36-4.77,15.12,4.3-1.35,4.77h0Z" />
      <path d="M80.87,56.98l.42-4.58,15.65,1.43-.42,4.58-15.65-1.43h0Z" />
    </g>
  </svg>
);
...
export const SettingsIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    ...
    />
    <path
      d="M13.5 8C13.5 8.6593 13.4153 9.29833 13.2575 9.90614L14.4893 11.1379L13.1379 12.4893L11.9061 11.2575C11.2983 11.4153 10.6593 11.5 10 11.5H8.5M2.5 8C2.5 7.3407 2.58469 6.70167 2.74252 6.09386L1.51068 4.86209L2.86209 3.51068L4.09386 4.74251C4.70167 4.58469 5.3407 4.5 6 4.5H10C11.3807 4.5 12.5 5.61929 12.5 7"
      stroke="currentColor"
      strokeLinecap="round"
      strokeWidth="1.5"
    />
